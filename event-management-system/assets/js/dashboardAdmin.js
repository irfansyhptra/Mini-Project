...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showEventDetails(eventId) {
    // Here you would normally fetch the event details from the server
  ...
  function deleteUser(userId) {
    ...
    confirmBtn.onclick = function() {
        // In a real app, would send delete request to server
        showNotification('User berhasil dihapus!', 'success');
        closeModal('confirmation-modal');
        
        // Remove the user row from the table (demo only)
        const userRows = document.querySelectorAll('#users-page tbody tr');
